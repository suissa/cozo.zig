...
test "ecommerce fixture has ten categories and thirty products" {
...
test "CozoDB opens, creates relations, populates ecommerce and executes relational query" {
    var db = try cozo.Database.open("mem", "", "");
    defer db.close();

    _ = try db.run(
        \:create user {id: String => username: String, role: String}
    ...
    const imported = try db.importRelations(std.testing.allocator,
        ...
        \{"relation":"category","columns":["id","slug","name"],"rows":[["cat-01","eletronicos","Eletronicos"],["cat-02","informatica","Informatica"],["cat-03","casa","Casa"],["cat-04","cozinha","Cozinha"],["cat-05","moda","Moda"],["cat-06","beleza","Beleza"],["cat-07","esportes","Esportes"],["cat-08","livros","Livros"],["cat-09","brinquedos","Brinquedos"],["cat-10","pet","Pet"]]},
